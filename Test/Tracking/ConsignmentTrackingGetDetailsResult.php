...
class ConsignmentTrackingGetDetailsResult
{
    ...
    /**
     * @param ResultState $ResultState
     * @return \UkMail\Test\Tracking\ConsignmentTrackingGetDetailsResult
     */
