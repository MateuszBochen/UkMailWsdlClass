...
class ConsignmentTrackingGetFullDetailsV3
{
    ...
    /**
     * @param GetConsignmentStatus $consignmentStatus
     * @return \UkMail\Test\Tracking\ConsignmentTrackingGetFullDetailsV3
     */
